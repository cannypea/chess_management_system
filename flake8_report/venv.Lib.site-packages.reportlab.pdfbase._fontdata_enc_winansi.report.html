...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\reportlab\pdfbase\_fontdata_enc_winansi.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.reportlab.pdfbase._fontdata_enc_winansi.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               venv\Lib\site-packages\reportlab\pdfbase\_fontdata_enc_winansi.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.reportlab.pdfbase._fontdata_enc_winansi.source.html#l37">
                  <tt><i>37</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
