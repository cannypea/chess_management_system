...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\ttkbootstrap\themes\user.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.ttkbootstrap.themes.user.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               venv\Lib\site-packages\ttkbootstrap\themes\user.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.ttkbootstrap.themes.user.source.html#l45">
                  <tt><i>45</i> <span class="n">USER_THEMES</span><span class="o">=</span><span class="p">{}</span></tt>
               </a>
            </li>
            </ul>
         </li>
